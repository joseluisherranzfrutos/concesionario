INSERT INTO concesionario.cliente (nif, nombre, direccion, ciudad, telefono, categoria, nVentas)
VALUES
  ('12345678A', 'Juan Lopez', 'Calle Gran Vía, 123', 'Madrid', '123456789', 'Plata',1),
  ('98765432B', 'Pedro Gonzalez', 'Calle Arganda, 20', 'Madrid', '987654321', 'Plata',1);
